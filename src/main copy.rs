...
fn main() {
    ...
    assert_eq!(
        [
            73052800, 73087584, 73122368, 73157152, 73191936, 73226720, 73261504, 73296288,
            73331072, 73365856, 73400640, 73435424, 73470208, 73504992, 73539776, 73574560,
            73609344, 73644128, 73678912, 73713696, 79779840, 79818720, 79857600, 79896480,
            79935360, 79974240, 80013120, 80052000, 80090880, 80129760, 80168640, 80207520,
            80246400, 80285280, 80324160, 80363040, 80401920, 80440800, 80479680, 80518560,
            80557440
        ],
